...
export default function CardPaymentStep({ details, onChange, onBack, onPay, amount }) {
  ...
  return (
    <StepWrapper
      eyebrow="Step 3 of 4"
      title="Card Payment"
      description="Enter your card and billing information to complete the booking."
    >
      <form
      ...
      >
        ...
        <label className="flex items-center gap-2.5 mb-6 cursor-pointer select-none">
          ...
          />
          <span className="text-sm text-gray-700">Save payment information for future checkout</span>
        </label>
