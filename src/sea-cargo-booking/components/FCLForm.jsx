...
export default function FCLForm({ formData, onChange, onNext }) {
  ...
  return (
    <StepWrapper
      eyebrow="FCL Ocean Freight"
      title="Shipment Details"
      description={`A dedicated container for your cargo. Delivery in ${breakdown.deliveryTime}.`}
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto items-start">
        ...
        >
          ...
          {/* Container & cargo */}
          <h3 className="text-sm font-bold text-gray-900 mb-3 uppercase tracking-wide">Container &amp; Cargo</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-6">
            <div className="min-w-0">
            ...
            <div className="min-w-0">
              <label htmlFor="containerType" className={labelClass}>Container Type *</label>
            ...
            <div className="min-w-0">
              ...
              <input id="hsCode" type="text" placeholder="e.g. 8471.30"
