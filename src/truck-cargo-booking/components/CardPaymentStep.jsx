...
function isValid(d) {
  ...
  const digits = String(d.cardNumber || "").replace(/\s/g, "");
  return digits.length >= 13 && req(d.expiry) && req(d.cvc) && req(d.cardholderName) &&
    req(d.addressLine1) && req(d.city) && req(d.postalCode);
}
