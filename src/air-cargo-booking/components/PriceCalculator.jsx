    ...
    >
      <div className="flex items-center justify-between mb-1">
        ...
        <span className="inline-flex px-2.5 py-1 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-wider">
          {service === "express" ? "Express" : "Economy"}
        </span>
      </div>
      ...
      <Row
        label={`Weight (${b.chargeableWeight} kg billable)`}
      ...
      <p className="text-[11px] text-gray-400 mt-3 leading-relaxed">
        Volumetric weight {b.volumetricWeight} kg · billed on the greater of actual vs. volumetric weight.
