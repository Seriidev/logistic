...
export default function SeaVideoSection() {
  ...
  return (
    <section className="page-container min-w-0 py-12 sm:py-16 lg:py-20">
      <SectionHeading
        ...
        title="Experience Our Sea Cargo Operations"
        description="Watch how YuuSell manages ocean freight from booking and container loading to vessel transit, customs clearance, and final delivery."
      />
      ...
      <div className="max-w-4xl mx-auto min-w-0">
        <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-gray-900 aspect-video group">
          {!playing ? (
            <>
              <ImageBlock
                src="/sea-video-thumb.jpg"
                alt="Sea cargo operations promotional video thumbnail"
                hint="Add photo: public/sea-video-thumb.jpg"
        ...
        <p className="text-sm sm:text-base text-gray-500 text-center mt-5 sm:mt-6 leading-relaxed max-w-2xl mx-auto">
          Discover our end-to-end sea cargo process — from LCL consolidation and FCL booking to vessel
          tracking and port delivery. Trusted by importers, exporters, and e-commerce businesses across
          six continents.
        </p>
      </div>
    </section>
