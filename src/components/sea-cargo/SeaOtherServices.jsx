...
const OTHER_SERVICES = [
  ...
  },
  {
    ...
    title: "Truck Cargo",
    description:
      "Reliable domestic and international road freight — FTL, LTL, and door-to-door delivery across major corridors.",
  ...
  },
  {
    ...
    description:
      "Same-day and next-day courier services for urgent documents and time-critical parcels worldwide.",
    ...
    <section className="bg-gray-50 min-w-0 py-12 sm:py-16 lg:py-20">
      <div className="page-container min-w-0">
        <SectionHeading
          ...
          description="Beyond ocean freight, YuuSell offers a complete suite of transportation, warehousing, and compliance solutions for your global supply chain."
        />
